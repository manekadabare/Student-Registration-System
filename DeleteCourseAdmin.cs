...
{
    public partial class DeleteCourseAdmin : Form
    {
        int courseid;
        ...
        private void DeleteCourseAdmin_Load(object sender, EventArgs e)
        {
            label3.ResetText();
            getcourseid();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                courseid  = int.Parse(comboBox3.Text);
                SqlCommand command = new SqlCommand("DELETE FROM coursedetails WHERE CourseID = " + int.Parse(comboBox3.Text) + "", connection);
