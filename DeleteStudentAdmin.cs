...
{
    public partial class DeleteStudentAdmin : Form
    {
        int stdid;
        ...
        private void DeleteStudentAdmin_Load(object sender, EventArgs e)
        {
            label3.ResetText();
            getstdid();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    stdid = int.Parse(comboBox3.Text);
                    SqlCommand command = new SqlCommand("DELETE FROM studentdetails WHERE StudentID = " + int.Parse(comboBox3.Text) + "", connection);
