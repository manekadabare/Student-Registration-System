...
{
    public partial class DeleteBatchAdmin : Form
    {
        ...
        int batchid;
        public DeleteBatchAdmin()
        {
            InitializeComponent();
            getbatchids();
        }

        private void DeleteBatchAdmin_Load(object sender, EventArgs e)
        {
            label6.ResetText();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    batchid = int.Parse(comboBox1.Text);
                    SqlCommand command = new SqlCommand("DELETE FROM batchdetails WHERE BatchID = " + int.Parse(comboBox1.Text) + "", connection);
